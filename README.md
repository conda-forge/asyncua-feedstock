...
Once the `conda-forge` channel has been enabled, `asyncua` can be installed with:

```
conda install asyncua
```

It is possible to list all of the versions of `asyncua` available on your platform with:
